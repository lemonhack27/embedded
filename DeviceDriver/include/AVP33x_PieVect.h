...
#ifndef AVP33x_PIE_VECT_H
#define AVP33x_PIE_VECT_H
...
// Non-Peripheral Interrupts:
      ...
      PINT     USER8;     // 用户定义陷阱8
      PINT     USER9;     // 用户定义陷阱9
      PINT     USER10;    // 用户定义陷阱10
      PINT     USER11;    // 用户定义陷阱11
      PINT     USER12;    // 用户定义陷阱12
...
#endif    // end of AVP33x_PIE_VECT_H definition
